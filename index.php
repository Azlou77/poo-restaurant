    ...
    <nav class="navbar navbar-dark navbar-expand-md sticky-top bg-dark d-flex justify-content-xl-center">
        <div class="container-fluid"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><img src="assets/img/home/logo-removebg-preview.png" width="50" height="50" style="margin-right: 315px;padding-right: 0px;padding-left: 0px;margin-left: 437px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person-fill text-white" style="font-size: 36px;padding-right: 0px;margin-right: 56px;padding-left: 0px;margin-left: 136px;">
