...
class ProductController extends DefaultController{
    ...
    public function createProduct(){
        if(isset($_POST['name_product']) && isset($_POST['prix_product']) && isset($_POST['description_product']) && isset($_POST['product_image'])){
            ...
            $product->setPrice(htmlspecialchars(intval($_POST['prix_product'])));
            $product->setDescription(htmlspecialchars($_POST['description_product']));
            $product->setImage(htmlspecialchars($_POST['product_image']));
            $product->setIdCategory(htmlspecialchars($_POST['product_category']));
